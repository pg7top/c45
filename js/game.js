class Game{
    ...
    showRank() {
        ...
        swal({
            title: `game!${"\n"}Rover${"\n"}`,
            text: "fica para outra vez",
            imageUrl:
              "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ8MaJ42ylT-PbkUHU4CWHA1igXqdbbBrEM1w&usqp=CAU",
            imageSize: "100x100",
            confirmButtonText: "aceito a derrota"
          });
